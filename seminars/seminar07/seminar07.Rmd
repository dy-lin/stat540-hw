...
## Explore the Methylation Data

```{r explore}
if(file.exists(here("seminars", "seminar07", "methyl_ALL.Rdata"))){ # if previously downloaded
  load(here("seminars", "seminar07", "methyl_ALL.Rdata"))
